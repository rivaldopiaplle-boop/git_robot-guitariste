...
def main(stdscr):
    ...
    menu_base = ["Activer le moteur", "Accorder", "Homing", "Choisir une chanson", "Jouer la chanson", "Réinitialiser le microcontrôleur", "Quitter"]
    selected = 0
    status_msg = None
    while True:
            ...
            if menu[selected] == "Quitter":
                ...
                while True:
                    ...
                    if k == curses.KEY_LEFT:
                        ...
                        note_idx = (note_idx + 1) % len(NOTE_NAMES)
                    elif k == curses.KEY_UP and octave < 6:
                        octave += 1
                    elif k == curses.KEY_DOWN and octave > 2:
                        octave -= 1
                ...
                while True:
                    ...
                    stdscr.refresh()
                    k = stdscr.getch()
                    if k == curses.KEY_UP and song_menu_idx > 0:
                        song_menu_idx -= 1
                    elif k == curses.KEY_DOWN and song_menu_idx < len(SONG_TITLES)-1:
                        song_menu_idx += 1
